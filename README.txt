...
* Rename the idfinder/ folder to the name of your module (eg "widget").
...
all the instances of the string "idfinder" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/idfinder/widget/g' {} \;

* Rename the file lang/en/idfinder.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_idfinder.php
...
and you should find that this idfinder has been added to the list of
installed modules.
